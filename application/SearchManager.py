    ...
    def add_track_items_to_table(self, tableToUpdate: QListWidget):
        try:
            ...
            for i, track in enumerate(self.tracks):
                # track.keys()
                """
                track["Track"].keys() --> ['album', 'artists', 'available_markets', 'disc_number', 'duration_ms', 'explicit', 'external_ids', 'external_urls', 'href', 'id', 'is_local', 'is_playable', 'name', 'popularity', 'preview_url', 'track_number', 'type', 'uri']
